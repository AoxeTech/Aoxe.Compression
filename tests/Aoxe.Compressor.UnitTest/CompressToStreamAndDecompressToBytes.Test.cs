...
public partial class CompressorTest
{
    ...
    [Fact]
    public void SystemIoCompressionZLibCompressToStreamAndDecompressToBytesTest() =>
        CompressToStreamAndDecompressToBytesTest(new SystemIoCompression.ZLibCompressor());
#endif
