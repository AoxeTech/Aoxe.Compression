...
{
    public static byte[] ToGZip(this byte[] rawBytes) =>
        SharpZipLibHelper.ToGZip(rawBytes);

    public static byte[] UnGZip(this byte[] compressBytes) =>
        SharpZipLibHelper.UnGZip(compressBytes);
