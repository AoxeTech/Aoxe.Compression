...
{
    public static void ToDeflate(this Stream rawStream, Stream outputStream, CompressionLevel compressionLevel = CompressionLevel.Optimal) =>
    ...
    public static MemoryStream ToDeflate(this Stream rawStream, CompressionLevel compressionLevel = CompressionLevel.Optimal) =>
