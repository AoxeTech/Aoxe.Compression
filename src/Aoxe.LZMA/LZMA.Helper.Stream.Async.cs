...
#if NETSTANDARD2_0
        _ = await inputStream.ReadAsync(properties, 0, 5, cancellationToken);
#else
        _ = await inputStream.ReadAsync(properties.AsMemory(0, 5), cancellationToken);
#endif
...
#if NETSTANDARD2_0
        _ = await inputStream.ReadAsync(fileLengthBytes, 0, 8, cancellationToken);
#else
        _ = await inputStream.ReadAsync(fileLengthBytes.AsMemory(0, 8), cancellationToken);
#endif
